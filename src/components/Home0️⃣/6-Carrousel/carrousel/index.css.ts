...
export const button = styleVariants({
	available: [
		baseButton,
		{
			...
			backgroundColor: 'linear-gradient(90deg, oklch(81.47% 0.0983 151.41) 0%, oklch(81.47% 0.1849 151.41) 100%)',
			...
			':hover': {
				...
				backgroundColor: 'light-dark(oklch(81.47% 0.1849 151.41), oklch(80.88% 0.1159 190.68))',
				borderBlock: 95,
			},
			':active': {
...
export const mainSectionRelative = style([T.container.large, { position: 'relative', isolation: 'isolate' }])
