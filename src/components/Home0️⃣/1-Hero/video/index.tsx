import { $, Resource, component$, useResource$, useSignal, useStyles$, useTask$ } from '@builder.io/qwik'
...
export default component$(() => {
	...
	return (
		<div onMouseover$={toggleOpen} onClick$={toggleOpen} class={open.value ? wrapper.open : wrapper.closed}>
			{open.value && (
				<>
