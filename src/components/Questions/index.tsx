...
export const IdContextOpen = createContextId<Signal<number>>('faq-active-open-id')
	...
	return (
		<div class={s.card}>
			<dt class={s.dt}>
				...
				<button class={s.dt__button} type='button' disabled={!activeP.value} aria-expanded={activeP.value}>
					+
				</button>
				{/* <h5></h5> */}
			</dt>
